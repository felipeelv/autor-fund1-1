...
> Trechos: O Que é um Pictograma? (linhas 536-559), Com Certeza Vai Acontecer (linhas 578-585), Impossível de Acontecer (linhas 586-593), Pode Acontecer ou Não (linhas 594-607)
...
- núcleo 1, papel amarelo, protagonista: frase `PICTOGRAMA é um gráfico que
  ...
  da Turma`; tabela `FRUTA` / `QUANTIDADE` com as quatro linhas (maçã 5,
  banana 3, uva 6, laranja 2), cada linha desenhando exatamente o número de
  frutas indicado; abaixo, box `PERGUNTAS SOBRE O GRÁFICO` com as três
  perguntas e respostas entre parênteses;
...
Contagem exata no pictograma: 5 maçãs, 3 bananas, 6 uvas, 2 laranjas — cada
fruta desenhada em quantidade idêntica ao número indicado. Exatamente 1
exemplo por categoria de possibilidade (certeza, impossível, depende), sem
