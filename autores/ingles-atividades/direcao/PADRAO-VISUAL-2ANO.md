# Padrão visual — atividades de Inglês · 2º ano

> **Derivado** do padrão do 3º ano (`PADRAO-VISUAL-3ANO.md`), em 18/08/2026,
...
Tudo o que `PADRAO-VISUAL-3ANO.md` define e não aparece abaixo **se mantém**: página vertical
