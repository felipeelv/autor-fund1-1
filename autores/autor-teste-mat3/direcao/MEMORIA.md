# Memória editorial — `autor-teste-mat3`
...
O conteúdo recebido em 14 de agosto de 2026 foi copiado integralmente para
`anos/3ano/fontes/2026-2-semestre/3bim-divisao-resto-geometria-v1.md`.

## Decisão de recorte

O primeiro lote tem seis páginas e distribui os conceitos essenciais das
Unidades 5 e 6. A limitação de seis páginas exige seleção editorial; o mapa em
`COBERTURA-DA-FONTE.md` explicita o que entrou e o que ficou somente na fonte.
