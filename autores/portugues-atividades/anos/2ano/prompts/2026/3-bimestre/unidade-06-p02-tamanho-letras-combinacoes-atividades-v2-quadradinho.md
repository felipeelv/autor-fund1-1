...
origem: unidade-06-p02-tamanho-letras-combinacoes-atividades-v1.md, corrigido o quadradinho ausente no primeiro balão da Atividade 1 e reforçada a cena "Voz alta"
---
...
Bloco 1 — Atividade 1: três balões ovais iguais, lado a lado. Em cada um
dos três, sem exceção, a frase seguida de um quadradinho vazio de contorno
fino para o sinal — inclusive no primeiro, de frase mais longa: se faltar
espaço, o balão fica mais largo ou a frase quebra em duas linhas, mas o
quadradinho sempre aparece. Frases e cenas: "Você comeu todo o bolo"
(abaixo, criança de olhos arregalados diante de um prato de bolo vazio, só
farelos); "FUJAM" (criança correndo, braços para cima, olhando para trás,
assustada); "Algo está vindo" (criança com lanterna num corredor escuro,
olhando uma porta entreaberta, tensa). Nenhum sinal dentro dos quadradinhos.
...
olhando fogos de artifício); "Era uma vez" (criança abrindo um livro de
histórias).
...
Título sem destaque. Atividade 1: quadradinho vazio nos três balões, sem
exceção. Atividade 2: nenhum traço, tracejado, ponto ou seta entre balão e
cartão; nenhum quadradinho ou lacuna dentro dos balões; ordem dos cartões
exatamente a listada. Atividade 3: nenhum sinal circulado ou com círculo
pré-impresso; linhas de escrita vazias. Atividade 4: contornos de rosto
completamente vazios. Sem confete. Invioláveis: não inventar termo ausente
