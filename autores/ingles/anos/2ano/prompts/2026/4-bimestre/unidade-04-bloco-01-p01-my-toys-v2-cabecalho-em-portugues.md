...
Correção sobre a v1 (17/09/2026): a faixa de abertura tinha sido traduzida
para inglês ("IN THIS UNIT, YOU WILL LEARN"). Nicolas Basso pediu que esse
cabeçalho fique em português nas três turmas (1º, 2º e 3º ano), igual ao
texto literal da fonte — corrigido para "NESTA UNIDADE VOCÊ VAI APRENDER".
Nenhum outro texto muda em relação à v1; mantém-se a nota de correção da v1
sobre o vocabulário de VOCABULÁRIO - TOYS copiado manualmente da fonte bruta
e a junção da quebra de linha de "Cores".
