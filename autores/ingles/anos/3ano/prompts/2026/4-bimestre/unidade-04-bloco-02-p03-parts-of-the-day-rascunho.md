...
>
> Fonte: `autores/ingles/anos/3ano/fontes/2026-2-semestre/4bim-bloco2.md`
> Trechos: NESTA UNIDADE VOCÊ VAI APRENDER (linhas 18-26), VOCABULÁRIO - PARTS OF THE DAY (linhas 44-59), ESTRUTURA: IN THE... (linhas 60-75)
> Autor: `ingles` · ano: `3ano` · unidade: unidade-04-bloco-02
>
...
página (abertura do bloco, vocabulário dos 4 períodos, estrutura "in the/at
...
- logo abaixo, faixa "IN THIS BLOCK, YOU WILL LEARN" com os quatro itens da
...
- bloco "IN THE... / AT NIGHT" com as quatro frases-estrutura e o aviso de
  atenção sobre "at night" não usar "in";
- caminho de leitura: título → o que você vai aprender → quatro períodos do
  dia → estrutura "in the.../at night".
...
O vocabulário dos quatro períodos do dia chegou fragmentado no rascunho —
o extrator perdeu o nome em inglês (MORNING/AFTERNOON/EVENING/NIGHT) e a
pronúncia de cada item, mantendo só partes do horário entre parênteses.
Reconstituído manualmente a partir da fonte bruta (`4bim-bloco2.md`, seção
VOCABULÁRIO - PARTS OF THE DAY) e conferido contra o original.
